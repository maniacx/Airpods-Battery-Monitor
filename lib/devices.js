...
export const ModelList = [
    ...
    {key: '1920', text: 'AirPods 4th Gen', multipleInfo: true, icon: 'airpod3'},
    {key: '1B20', text: 'AirPods 4th Gen with ANC', multipleInfo: true, icon: 'airpod3'},
    ...
    {key: '1F20', text: 'AirPods Max USB-C', multipleInfo: false, icon: 'airpodmax'},
    {key: 'B', text: 'Powerbeats Pro', multipleInfo: true, icon: 'powerbeats'},
    {key: '0C20', text: 'Beats Solo Pro', multipleInfo: false, icon: 'solo'},
    {key: '0D20', text: 'Powerbeats 4', multipleInfo: false, icon: 'powerbeats'},
    {key: '1720', text: 'Beats Studio Pro', multipleInfo: false, icon: 'studio'},
    {key: '1120', text: 'Beats Studio Buds', multipleInfo: true, icon: 'buds'},
    {key: '1620', text: 'Beats Studio Buds Plus', multipleInfo: true, icon: 'buds'},
];
